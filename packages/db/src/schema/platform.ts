...
export const sites = pgTable("sites", {
  ...
  uniqueIndex("sites_tenant_id_id_ux").on(t.tenantId, t.id),
  foreignKey({ columns: [t.tenantId, t.organizationId], foreignColumns: [organizations.tenantId, organizations.id], name: "sites_organization_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.organizationLocationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.id], name: "sites_location_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.organizationId, t.organizationLocationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.organizationId, organizationLocations.id], name: "sites_location_organization_fk" }),
  uniqueIndex("sites_slug_ux").on(t.slug), index("sites_tenant_status_idx").on(t.tenantId, t.status),
]);
...
export const siteContents = pgTable("site_contents", {
  ...
  foreignKey({ columns: [t.tenantId, t.siteId], foreignColumns: [sites.tenantId, sites.id], name: "site_contents_site_tenant_fk" }),
  uniqueIndex("site_contents_key_ux").on(t.siteId, t.contentKey),
]);
...
export const siteForms = pgTable("site_forms", {
  ...
  uniqueIndex("site_forms_tenant_site_id_ux").on(t.tenantId, t.siteId, t.id),
  foreignKey({ columns: [t.tenantId, t.siteId], foreignColumns: [sites.tenantId, sites.id], name: "site_forms_site_tenant_fk" }),
]);
...
export const siteSubmissions = pgTable("site_submissions", {
  ...
  foreignKey({ columns: [t.tenantId, t.siteId], foreignColumns: [sites.tenantId, sites.id], name: "site_submissions_site_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.siteId, t.siteFormId], foreignColumns: [siteForms.tenantId, siteForms.siteId, siteForms.id], name: "site_submissions_form_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.leadId], foreignColumns: [leads.tenantId, leads.id], name: "site_submissions_lead_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.customerId], foreignColumns: [customers.tenantId, customers.id], name: "site_submissions_customer_tenant_fk" }),
  uniqueIndex("site_submissions_idempotency_ux").on(t.siteId, t.idempotencyKey),
]);
...
}, (t) => [uniqueIndex("terms_versions_tenant_id_id_ux").on(t.tenantId, t.id), uniqueIndex("terms_versions_type_version_ux").on(t.tenantId, t.documentType, t.version)]);
...
}, (t) => [foreignKey({ columns: [t.tenantId, t.termsVersionId], foreignColumns: [termsVersions.tenantId, termsVersions.id], name: "terms_acceptances_version_tenant_fk" })]);
...
export const apiCredentials = pgTable("api_credentials", {
  ...
  foreignKey({ columns: [t.tenantId, t.createdByMembershipId], foreignColumns: [memberships.tenantId, memberships.id], name: "api_credentials_creator_tenant_fk" }),
  uniqueIndex("api_credentials_hash_ux").on(t.tokenHash), index("api_credentials_tenant_status_idx").on(t.tenantId, t.status),
]);
...
export const webhookSubscriptions = pgTable("webhook_subscriptions", {
  ...
  uniqueIndex("webhook_subscriptions_tenant_id_id_ux").on(t.tenantId, t.id),
  foreignKey({ columns: [t.tenantId, t.createdByMembershipId], foreignColumns: [memberships.tenantId, memberships.id], name: "webhook_subscriptions_creator_tenant_fk" }),
]);
...
export const domainEvents = pgTable("domain_events", {
  ...
  foreignKey({ columns: [t.tenantId, t.locationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.id], name: "domain_events_location_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.organizationId, t.locationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.organizationId, organizationLocations.id], name: "domain_events_location_organization_fk" }),
  index("domain_events_outbox_idx").on(t.publishedAt), index("domain_events_tenant_entity_idx").on(t.tenantId, t.entityType, t.entityId),
]);
...
export const webhookDeliveries = pgTable("webhook_deliveries", {
  ...
  foreignKey({ columns: [t.tenantId, t.webhookSubscriptionId], foreignColumns: [webhookSubscriptions.tenantId, webhookSubscriptions.id], name: "webhook_deliveries_subscription_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.domainEventId], foreignColumns: [domainEvents.tenantId, domainEvents.id], name: "webhook_deliveries_event_tenant_fk" }),
  uniqueIndex("webhook_deliveries_event_ux").on(t.webhookSubscriptionId, t.domainEventId),
]);
...
export const metricSnapshots = pgTable("metric_snapshots", {
  ...
  foreignKey({ columns: [t.tenantId, t.organizationId], foreignColumns: [organizations.tenantId, organizations.id], name: "metric_snapshots_organization_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.organizationLocationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.id], name: "metric_snapshots_location_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.organizationId, t.organizationLocationId], foreignColumns: [organizationLocations.tenantId, organizationLocations.organizationId, organizationLocations.id], name: "metric_snapshots_location_organization_fk" }),
  index("metric_snapshots_key_period_idx").on(t.tenantId, t.metricKey, t.periodStart, t.periodEnd),
]);
...
export const internalNotifications = pgTable("internal_notifications", {
  ...
  foreignKey({ columns: [t.tenantId, t.membershipId], foreignColumns: [memberships.tenantId, memberships.id], name: "internal_notifications_member_tenant_fk" }),
  index("internal_notifications_member_idx").on(t.tenantId, t.membershipId, t.readAt),
]);
...
export const franchiseAgreements = pgTable("franchise_agreements", {
  ...
  uniqueIndex("franchise_agreements_tenant_id_id_ux").on(t.tenantId, t.id),
  foreignKey({ columns: [t.tenantId, t.parentOrganizationId], foreignColumns: [organizations.tenantId, organizations.id], name: "franchise_agreements_parent_tenant_fk" }),
  foreignKey({ columns: [t.tenantId, t.childOrganizationId], foreignColumns: [organizations.tenantId, organizations.id], name: "franchise_agreements_child_tenant_fk" }),
]);
...
}, (t) => [foreignKey({ columns: [t.tenantId, t.franchiseAgreementId], foreignColumns: [franchiseAgreements.tenantId, franchiseAgreements.id], name: "royalty_rules_agreement_tenant_fk" })]);
...
}, (t) => [foreignKey({ columns: [t.tenantId, t.franchiseAgreementId], foreignColumns: [franchiseAgreements.tenantId, franchiseAgreements.id], name: "royalty_statements_agreement_tenant_fk" })]);
